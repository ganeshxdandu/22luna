            ...
            <div className="max-w-[1100px] mx-auto flex flex-col lg:flex-row gap-16 items-stretch">
                ...
                <div className="flex flex-col gap-10 max-w-[540px]">
                    ...
                    >
                        ...
                        >
                            Dr. Niharika{" "}
                            <span className="text-[#B08D6A]">Mandhyan</span>
                        </h2>

                        <p className="text-sm mt-2 text-[#8B6F5C]">
                            BDS · MDS Prosthodontics · Masters in Aesthetic
                            Medicine
                        </p>
                    </motion.div>
                    ...
                    >
                        <p className="text-[18px] italic leading-[1.6] text-[#4B341B]">
                            "Your skin, your smile — treated by someone who has
                            spent a decade perfecting both."
                        </p>
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        className="flex flex-col gap-5 text-[15px] leading-[1.75] text-[#6F655D] md:text-justify"
                    >
                        <p>
                            Dr. Niharika Mandhyan didn’t set out to build just
                            another clinic. She set out to change what aesthetic
                            care looks like in India — starting with the belief
                            that every patient deserves treatments designed
                            around their unique skin, their real concerns, and
                            their life.
                        </p>

                        <p>
                            Armed with an MDS in Prosthodontics from V.S. Dental
                            College, Bangalore, and a Masters in Aesthetic
                            Medicine, she has spent over a decade crossing
                            continents — training under world-renowned
                            specialists and mastering procedures that simply
                            were not available in India before she brought them
                            here.
                        </p>

                        <p>
                            She has partnered with global leaders like Lumenis
                            and Inmode, pioneered treatments for skin of color,
                            and holds advanced certifications in thread lifting,
                            Botox and dermal fillers. But what patients remember
